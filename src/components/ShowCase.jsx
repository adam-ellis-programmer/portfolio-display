 ...
 * 
  ...
  return (
    <section id='showCase' className='min-h-screen'>
      ...
      <div className='px-5 md:px-0 max-w-[1200px] m-auto grid md:grid-cols-2 my-5'>
        <div className=' my-5 md:my-0'>
          <ul className='grid grid-cols-2'>
            ...
            <li className='flex items-center mb-1'>
              <i className='fa-solid fa-circle-check text-2xl text-[#60a5fa]'></i>
              <span className='ml-2 text-[1.2rem]'>18+ Full Stack</span>
            </li>
            <li className='flex items-center mb-1'>
              <i className='fa-solid fa-circle-check text-2xl text-[#60a5fa]'></i>
      ...
      <div className=' max-w-[700px] mx-auto mb-6 rounded flex justify-center items-center bg-red-300 p-2 ml-3 mr-3'>
        <div className=''>
            ...
            >
              <a href={item.link} className=''>
                ...
                <div className='absolute  top-0 bottom-0 left-0 right-0 bg-[#012840]/40 flex items-center justify-center md:rounded-[0.6rem] flex-col z-10'>
                  <div className='bg-[#375077]/90 p-5 rounded shadow-2xl -shadow-2xl'>
                    <h3 className='text-white text-2xl  text-center md:leading-11'>
                      {item.lineOne}
                    </h3>
                    <p className='text-2xl text-white text-center  md:leading-11'>
                      {item.lineTwo}
                    </p>
                  </div>
                </div>
